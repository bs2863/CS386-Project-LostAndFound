...
NAU Lost \& Found helps students and staff quickly find lost belongings by swiftly
and effortlessly matching owners with their lost items across campus, making item
retrieval a breeze.


### Customer Segment

University students and staff members who lose personal items (Student IDs,
laptops, water bottles, backpacks, etc) across campus facilities should
...
>"If a website existed and it only took like two minutes to search it up online
...
>"Having one place I could go \[to look] would be REALLY nice, there's like 3 or 4 different phone numbers and emails for different buildings and the buses, right?
...
* Did not contact anyone because they assumed the item was gone.
...
The original value proposition was more 'slogany', and did not specify a measurable benefit. The new proposition addresses the 'product' more directly, and narrows in on some notes from our interviews like how interview 3 mentioned that having 3 or 4 different phone numbers/emails associated with different buildings. Interview 2 expressed interest in using a single site rather than 'walking all over campus'. Having a single, comprehensive point to check is a tangible benefit of the system that multiple interviewees seemed interested in.
